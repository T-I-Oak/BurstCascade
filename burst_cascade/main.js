...
export class Game {
    constructor() {
        ...
        this.versionDisplay = getEl('version-display');
        if (this.versionDisplay && typeof __APP_VERSION__ !== 'undefined') {
            this.versionDisplay.textContent = `Ver ${__APP_VERSION__}`;
        }
